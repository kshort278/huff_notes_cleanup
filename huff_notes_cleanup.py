...
def main():
    ...
    for line in s:
        ...
        #take off new line character and add a * as a marker for the end of each line
        text_line = line.rstrip('\n')
        text_line = text_line + '*'

        #get rid of "Program Date" column in header
    ...
    #each record formatted except header is written to new file
